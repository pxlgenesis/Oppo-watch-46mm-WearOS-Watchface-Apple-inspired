...
public class MyWatchFace extends CanvasWatchFaceService {
    ...
    private class Engine extends CanvasWatchFaceService.Engine {
        ...
        public void onTapCommand(int tapType, int x, int y, long eventTime) {
            switch (tapType) {
                ...
                case TAP_TYPE_TAP:
                    ...
                    Toast.makeText(getApplicationContext(), R.string.complicationDrawable_noDataText, Toast.LENGTH_SHORT)
                            .show();
                    break;
            }
            invalidate();
        ...
        public void onDraw(Canvas canvas, Rect bounds) {
            ...
            canvas.drawText(mCalendar.get(Calendar.HOUR_OF_DAY) + ":" +
                            mCalendar.get(Calendar.MINUTE), mCenterX, mCenterY, mCenterPaint);
